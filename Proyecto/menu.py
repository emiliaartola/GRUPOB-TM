...
class MainMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text('Menu Principal', 45, self.game.DISPLAY_W / 2, self.game.DISPLAY_H - 230, self.game.BLACK)
            self.game.draw_text("Jugar", 30, self.startx, self.starty, self.game.BLACK)
            self.game.draw_text("Opciones", 30, self.optionsx, self.optionsy, self.game.BLACK)
            self.game.draw_text("Creditos", 30, self.creditsx, self.creditsy, self.game.BLACK)
            self.draw_cursor()
            self.blit_screen()
